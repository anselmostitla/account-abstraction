...
contract MinimalAccount is IAccount, Ownable{
   ...
   error MinimalAccount__FailedPreFund();
   ...
   *//////////////////////////////////////////////////////////
   ...
   constructor(address entryPoint) Ownable(msg.sender) {
      i_entryPoint = IEntryPoint(entryPoint); // The entry point will call this contract
   }
   ...
   *//////////////////////////////////////////////////////////
   ...
   // EIP-191 version of the sign hash
   ...
   function _payPrefund(uint256 missingAccountFunds) internal {
      require(address(this).balance >= missingAccountFunds, "Not enought funds...");
      if (missingAccountFunds != 0) {
         (bool success, ) = payable(msg.sender).call{value:missingAccountFunds, gas:type(uint256).max}("");
         if (!success) { revert MinimalAccount__FailedPreFund();}
      }
   }
